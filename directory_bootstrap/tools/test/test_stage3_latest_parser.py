...
class TestStag3LatestParser(TestCase):
    def test_(self):
        content = dedent("""\
                ...
                """)
        (year, month, day), _1, arch_flavor = find_latest_stage3_date(content, 'http://distfiles.gentoo.org/releases/amd64/autobuilds/latest-stage3.txt', 'amd64')
        self.assertEqual((year, month, day, arch_flavor), (2015, 10, 1, ''))
